...
| ----------- | ------------ | ----- |
| `calibrated_explanations.rst` (legacy landing page) | :doc:`../../index` | Landing narrative split into role-based overview and section toctrees. |
...
- Point readers to the research hub near the top of those same pages (for example, in a Resources section) so they can jump to :doc:`../../researcher/index` without introducing a research banner component.
