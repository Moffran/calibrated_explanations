...
- For the full milestone scope—including calibrated-explanations-first messaging
  and governance updates—see the `v0.9.0 release plan <https://github.com/Moffran/calibrated_explanations/blob/main/development/current-work/RELEASE_PLAN_v1.md#v090-documentation-realignment--targeted-runtime-polish>`_.
