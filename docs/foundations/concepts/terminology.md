...
- See the [ADR-021 Terminology section (GitHub)](https://github.com/Moffran/calibrated_explanations/blob/main/development/adrs/ADR-021-calibrated-interval-semantics.md) for details
...
- [ADR-021: Calibrated Interval Semantics (GitHub)](https://github.com/Moffran/calibrated_explanations/blob/main/development/adrs/ADR-021-calibrated-interval-semantics.md)
