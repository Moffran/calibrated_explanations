...
* [ADR-029 reject integration strategy (GitHub)](https://github.com/Moffran/calibrated_explanations/blob/main/development/adrs/ADR-029-reject-integration-strategy.md) - Reject architecture
