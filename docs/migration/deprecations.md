...
| `CalibratedExplainer.is_lime_enabled(...)` | `external_plugins.integrations.lime_pipeline.LimePipeline(...).is_enabled(...)` | v0.11.1 | v0.11.2 | Task-21 inventory item; helper-enabled flag no longer lives on core explainer surface. |
| `CalibratedExplainer.is_shap_enabled(...)` | `external_plugins.integrations.shap_pipeline.ShapPipeline(...).is_enabled(...)` | v0.11.1 | v0.11.2 | Task-21 inventory item; helper-enabled flag no longer lives on core explainer surface. |
