...
- See [ADR-021 Terminology section](https://github.com/Moffran/calibrated_explanations/blob/main/improvement_docs/adrs/ADR-021-calibrated-interval-semantics.md#terminology-probabilistic-regression-vs-thresholded-regression) for details
...
- [ADR-021: Calibrated Interval Semantics](https://github.com/Moffran/calibrated_explanations/blob/main/improvement_docs/adrs/ADR-021-calibrated-interval-semantics.md)
- [Terminology Analysis (full report)](https://github.com/Moffran/calibrated_explanations/blob/main/improvement_docs/TERMINOLOGY_ANALYSIS_THRESHOLDED_VS_PROBABILISTIC_REGRESSION.md)

---

## Questions?

See the [FAQ section in the concept guide](../foundations/concepts/probabilistic_regression.md#faq) or file an issue on GitHub.
