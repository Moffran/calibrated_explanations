# v0.8 → v0.9: Terminology Standardization
...
- See [ADR-021 Terminology section](../../improvement_docs/adrs/ADR-021-calibrated-interval-semantics.md#terminology-probabilistic-regression-vs-thresholded-regression) for details
...
- **v0.9.0:** Terminology standardized; `_is_thresholded()` renamed
...
- [ADR-021: Calibrated Interval Semantics](../../improvement_docs/adrs/ADR-021-calibrated-interval-semantics.md)
- [Terminology Analysis (full report)](../../TERMINOLOGY_ANALYSIS_THRESHOLDED_VS_PROBABILISTIC_REGRESSION.md)
