...
| Guarded explanations | `explain_guarded_factual()` | Rule-level plausibility filtering + auditable interval removal metadata for hypothetical perturbations (AI Act Art. 9, 12) |
