...
| Guarded explanations | `explain_factual(guarded=True)` / `explore_alternatives(guarded=True)` | Rule-level plausibility filtering + auditable interval removal metadata for hypothetical perturbations (AI Act Art. 9, 12) |
