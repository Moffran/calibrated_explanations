...
All generation must comply with `tests/README.md`. Summarize at the end which existing file you extended (or document the required “Why a new test file?” justification when you truly create one).
