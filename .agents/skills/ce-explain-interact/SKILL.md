...
explanations[0].to_narrative(
    expertise_level="beginner",          # or "intermediate" or "advanced" or ("beginner", "advanced") or whatever mic you want
    output_format="text",                # "text", "dataframe", other supported formats
)

# or
explanations[0].narrate(                 # narrate is an alias for to_narrative
...
```python
# Single instance
explanations[0].plot()                                     # see defaults below
explanations[0].plot(filter_top=15)                        # show top-15 rules
