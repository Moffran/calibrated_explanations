...
Use this skill whenever `.Codex/skills/` changes or whenever a user requests
...
2. Ensure all `.Codex/skills/*` entries are listed exactly once.
3. Keep links stable (`.Codex/skills/<skill>/SKILL.md`).
...
2. Update `.Codex/skills/ce-onboard/SKILL.md` section 4 skill catalogue in the same patch.
...
rg -n "## 4\\. Skill catalogue|ce-skill-registry-sync" .Codex/skills/ce-onboard/SKILL.md
rg -n "Agent skill catalogue|ce-skill-registry-sync|\\.Codex/skills/.*/SKILL.md" docs/contributor/agent_skills.md
```

Then compare the discovered skill folders to:
- `CONTRIBUTOR_INSTRUCTIONS.md` Table 6A entries
- `.Codex/skills/ce-onboard/SKILL.md` section 4 catalogue entries
