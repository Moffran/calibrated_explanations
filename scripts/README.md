...
- `check_docstring_coverage.py`: reports module/class/function/method docstring coverage so Standard-002 adoption can be monitored. Use `--fail-under` locally when experimenting with stricter thresholds.
