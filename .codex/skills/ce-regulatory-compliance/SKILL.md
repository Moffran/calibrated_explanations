...
| Guarded explanations | `explain_factual(..., guarded_options=GuardedOptions())` | Rule-level plausibility filtering + auditable interval removal metadata for hypothetical perturbations (AI Act Art. 9, 12) |
