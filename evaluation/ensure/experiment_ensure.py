...
for loader in datasets:
    ...
    for cal_size in calibration_sizes:
        ...
        for explanation in explanations:
            ...
            cf = deepcopy(explanation).counter_explanations()
            cp = deepcopy(explanation).counter_explanations(include_potential=True)
            sef = deepcopy(explanation).semi_explanations()
            sep = deepcopy(explanation).semi_explanations(include_potential=True)
            suf = deepcopy(explanation).super_explanations()
            sup = deepcopy(explanation).super_explanations(include_potential=True)
