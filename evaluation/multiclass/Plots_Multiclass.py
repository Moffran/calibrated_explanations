...
for dataSet in [
    ...
    "whole",
    "yeast",
]:  # "iris", "tae", "image", "wineR", "glass", "vehicle", "wineW", "wine", "cmc", \
    #
    ...
    test_idx = [
        np.where(y == i)[0][: int(num_to_test / no_of_classes)] for i in range(no_of_classes)
    ]
    ...
    for i in range(num_to_test):
        ...
        factual_explanations.plot(
            ...
            filename=f"{dataSet}/{dataSet}_factual_i{i}_c{y_test[i]}_p{predicted}.png",
        )
        factual_explanations.plot(
            i,
            uncertainty=True,
            filter_top=features_to_plot,
            filename=f"{dataSet}/{dataSet}_factual_uncertainty_i{i}_c{y_test[i]}_p{predicted}.png",
        )
    ...
    for i in range(num_to_test):
        ...
        alternative_explanations.plot(
            i,
            filter_top=features_to_plot,
            filename=f"{dataSet}/{dataSet}_alternative_i{i}_c{y_test[i]}_p{predicted}.png",
        )
    ...
    for i in range(num_to_test):
        ...
        factual_explanations.plot(
            i,
            filter_top=features_to_plot,
            filename=f"{dataSet}/{dataSet}_factual_Mondrian_i{i}_c{y_test[i]}_p{predicted}.png",
        )
        factual_explanations.plot(
            i,
            uncertainty=True,
            filter_top=features_to_plot,
            filename=f"{dataSet}/{dataSet}_factual_uncertainty_Mondrian_i{i}_c{y_test[i]}_p{predicted}.png",
        )
    ...
    for i in range(num_to_test):
        ...
        alternative_explanations.plot(
            i,
            filter_top=features_to_plot,
            filename=f"{dataSet}/{dataSet}_alternative_Mondrian_i{i}_c{y_test[i]}_p{predicted}.png",
        )
