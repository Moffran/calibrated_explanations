...
CLASSIFICATION_SAMPLES: int = 3000
CLASSIFICATION_FEATURES: int = 8
CLASSIFICATION_INFORMATIVE: int = 6
CLASSIFICATION_REDUNDANT: int = 0
CLASSIFICATION_ESTIMATORS: int = 100

REGRESSION_SAMPLES: int = 3000
REGRESSION_FEATURES: int = 6
REGRESSION_INFORMATIVE: int = 5
REGRESSION_NOISE: float = 0.2
REGRESSION_ESTIMATORS: int = 120

CALIBRATION_SIZE: int = 1000
TEST_SIZE: int = 1000

TIMING_REPEAT: int = 100
TIMING_WARMUP: int = 1
