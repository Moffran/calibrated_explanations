...
class TestAlternativeExplanation:
    ...
    def test_super_explanations(self, explanation):
        ...
        rules = {
            ...
            "weight": [0,0,0], "weight_low": [0,0,0], "weight_high": [0,0,0],
            "value": [1,2,3], "rule": ["r1","r2","r3"], "feature": [0,1,0],
            "sampled_values": [[],[1],[]], "feature_value": [None,None,None],
            "is_conjunctive": [False,False,False], "classes": [0,1],
            "base_predict_low": 0.2, "base_predict_high": 0.4 
        }
    ...
    def test_ensured_explanations(self, explanation):
        ...
        rules = {
            ...
            "weight": [0,0], "weight_low": [0,0], "weight_high": [0,0],
            "value": [1,2], "rule": ["r1","r2"], "feature": [0,1],
            "sampled_values": [[],[1]], "feature_value": [None,None],
            "is_conjunctive": [False,False], "classes": [0,1],
            "base_predict_low": 0.4, "base_predict_high": 0.6
        }
        self.setup_test_rules(explanation, rules)
