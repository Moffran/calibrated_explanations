...
class ConcreteExplanation(CalibratedExplanation):
    ...
    def add_conjunctions(self, *args):
        pass
...
def test_explanation_init_variants():
    ...
    assert np.array_equal(
        exp.prediction["__full_probabilities__"], prediction["__full_probabilities__"]
    )
...
def test_explanation_get_explainer_fallbacks():
    ...
    exp2 = ConcreteExplanation(
        mock_ce_2, 0, np.array([[1]]), {}, {}, {}, {"predict": [0.5], "low": [0.4], "high": [0.6]}
    )
    ...
    exp3 = ConcreteExplanation(
        mock_ce_3, 0, np.array([[1]]), {}, {}, {}, {"predict": [0.5], "low": [0.4], "high": [0.6]}
    )
...
def test_explanation_add_conjunction_warnings():
    ...
    exp = ConcreteExplanation(
        mock_ce, 0, np.array([[1, 2]]), {}, {}, {}, {"predict": [0.5], "low": [0.4], "high": [0.6]}
    )
...
def test_explanation_define_conditions_no_discretizer():
    ...
    exp = ConcreteExplanation(
        mock_ce, 0, np.array([1.5]), {}, {}, {}, {"predict": [0.5], "low": [0.4], "high": [0.6]}
    )
