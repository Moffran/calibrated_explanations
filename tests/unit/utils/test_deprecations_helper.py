...
class TestShouldRaise:
    ...
    def test_should_not_raise_during_pytest_without_ci(self):
        ...
        with patch.dict(os.environ, env):
            ...
            with patch("calibrated_explanations.utils.deprecations._CE_DEPRECATIONS_AT_START", "error"):
...
class TestDeprecate:
    ...
    def test_should_emit_warning_when_not_set_to_raise(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            with pytest.warns(DeprecationWarning, match="Test warning"):
    ...
    def test_should_raise_deprecation_when_set_to_error(self):
        ...
        with patch.dict(os.environ, {"CE_DEPRECATIONS": "error"}):
            with patch("calibrated_explanations.utils.deprecations._should_raise", return_value=True):
                with pytest.raises(DeprecationWarning, match="Test error message"):
    ...
    @pytest.mark.xfail(reason="Global state pollution in full suite due to deprecations module design")
    ...
    def test_should_emit_per_test_under_pytest(self):
        ...
        with patch.dict(os.environ, env):
            ...
            assert pytest_test_id in _EMITTED_PER_TEST
            assert unique_key in _EMITTED_PER_TEST[pytest_test_id]
    ...
    def test_should_record_key_when_raising_in_ci(self):
        ...
        with patch.dict(os.environ, {"CI": "true", "CE_DEPRECATIONS": "error"}, clear=True):
