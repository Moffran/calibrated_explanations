...
:meth:`~calibrated_explanations.CalibratedExplainer.explain_factual(..., guarded=True)` and
:meth:`~calibrated_explanations.CalibratedExplainer.explore_alternatives(..., guarded=True)`.
