...
1. `development/adrs/ADR-001-core-decomposition-boundaries.md`
2. `development/adrs/ADR-006-plugin-registry-trust-model.md`
3. `development/adrs/ADR-010-core-vs-evaluation-split-and-distribution.md`
4. `development/adrs/ADR-011-deprecation-and-migration-policy.md`
5. `development/adrs/ADR-013-interval-calibrator-plugin-strategy.md`
6. `development/adrs/ADR-037-visualization-extension-and-rendering-governance.md`
7. `development/adrs/ADR-015-explanation-plugin.md`
8. `development/adrs/ADR-020-legacy-user-api-stability.md`
9. `development/adrs/ADR-026-explanation-plugin-semantics.md`
10. `development/adrs/ADR-030-test-quality-priorities-and-enforcement.md`
