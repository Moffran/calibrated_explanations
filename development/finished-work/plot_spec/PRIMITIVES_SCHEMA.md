> **Finished:** Informal schema documentation for the exported primitives structure. PlotSpec promoted to default in v0.11.3. The canonical JSON schema is at `development/schemas/primitives_schema.json`.
