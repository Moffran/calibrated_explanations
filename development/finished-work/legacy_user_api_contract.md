> **Finished:** API surface inventory that informed ADR-020 (`development/adrs/ADR-020-legacy-api-stability-contract.md`). ADR-020 is the governing stability contract; this file is the supporting analysis and evidence record. Retained as historical reference; do not update.
