> **Active scope:** Engineering standard for internal module and symbol naming conventions (snake_case modules, PascalCase classes, deprecated-shim isolation policy). Remains active as long as Standard-001 governs CE naming; revised when the nomenclature policy is updated.
