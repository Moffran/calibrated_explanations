> **Active scope:** ADR-030 agent role: detects test anti-patterns (private-member access, brittle coupling, weak assertions) and produces remediation recommendations. Remains active as long as this role is part of the quality improvement cycle; updated when the cycle process or ADR-030 is revised.
...
- ADR-030: `development/adrs/` (search for ADR-030)
