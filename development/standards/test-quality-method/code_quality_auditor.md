> **Active scope:** ADR-030 agent role: audits source-code quality gates (exception taxonomy, import boundaries, docstrings, deprecations) and identifies refactor targets. Remains active as long as this role is part of the quality improvement cycle.
