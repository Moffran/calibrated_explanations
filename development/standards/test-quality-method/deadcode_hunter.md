> **Active scope:** ADR-030 agent role: identifies unreachable or non-contributing source code through evidence-based analysis and recommends safe removal. Remains active as long as this role is part of the quality improvement cycle.
