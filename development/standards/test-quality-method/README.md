> **Active scope:** Top-level guide for the ADR-030 Quality Improvement Method; describes the three cycle options (A: test-focused, B: code-focused, C: combined) and the shared verification gates. Remains active as long as ADR-030 governs CE test and code quality; updated when ADR-030 is revised.
...
- Maintain ADR conformance; consult `development/adrs/` for relevant ADRs before major changes.
