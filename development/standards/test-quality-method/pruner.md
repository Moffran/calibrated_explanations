> **Active scope:** ADR-030 agent role: identifies low-value or redundant tests for safe removal while protecting coverage and behavioral contracts. Remains active as long as this role is part of the quality improvement cycle.
