> **Active scope:** ADR-030 agent role: designs high-value behavioral tests to close coverage gaps and replace padding tests with public-contract verification. Remains active as long as this role is part of the quality improvement cycle.
