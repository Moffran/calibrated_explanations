> **Active scope:** ADR-030 agent role: executes approved test and code changes, applies patches, and verifies the result passes all quality gates. Remains active as long as this role is part of the quality improvement cycle.
