> **Active scope:** ADR-030 agent role: designs the quality improvement cycle and sequences sub-tasks across the team; selects Option A, B, or C focus per cycle. Remains active as long as this role is part of the quality improvement cycle.
...
- `development/standards/test-quality-method/README.md` -- the canonical workflow
...
- ADR-030 (search in `development/adrs/` for the test quality
...
- `development/adrs/` (ADR-030 and related)
