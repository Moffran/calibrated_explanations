...
- **Related Standards:** Standard-004 (Documentation Audience Standard)

### Standard-004 status snapshot
...
1. Update ADR-022 to mark it superseded by Standard-004 and adopt the new documentation standard. (done; completed in v0.8.0)
