...
- **Mixed module naming styles.** Core implementation files mix CamelCase, snake_case, and legacy-style prefixes (for example, `core/venn_abers.py`, `core/interval_regressor.py`, `viz/plots.py`, and `legacy/_plots_legacy.py` live side-by-side), making it unclear which modules are public, private, or transitional. 【F:src/calibrated_explanations/core/venn_abers.py†L1-L120】【F:src/calibrated_explanations/core/interval_regressor.py†L1-L40】【F:src/calibrated_explanations/viz/plots.py†L1-L40】【F:src/calibrated_explanations/legacy/_plots_legacy.py†L1-L40】
